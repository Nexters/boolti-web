...
export const privacyTableContent: Table = {
  ...
  items: [
    {
      head: '구분',
      rows: [{ children: '이용자 상품 구매' }, { children: 'CS처리' }],
    },
    {
      head: '수집 및 이용 목적',
      rows: [
        ...
        {
          children:
            '민원인 신원 확인, 민원 사항 확인, 사실 조사를 위한 연락 및 통지, 처리 결과 통보',
        },
      ],
    },
    {
      ...
      rows: [
        {
          children:
            '성명, 휴대전화 번호, 이메일,상품구매정보(카드 결제 정보, 계좌 정보, 예매자 정보(성명, 휴대전화 번호)',
        },
        {
          children: '결제자명, 결제자 연락처, 입금자명, 주문번호, CS처리 기록 등',
        },
      ],
    },
    {
  ...
  items: [
    ...
    },
    {
      ...
      rows: [
        {
          children:
            '이용자가 구매한 제품의 배송, 입장 확인, 고객상담, AS등 불만 처리, 취소, 환불, 혜택 제공등',
        },
      ],
    },
    {
      head: '제공 항목',
      rows: [{ children: '예매자명, 연락처, 주문번호, 결제금액, 결제 방법' }],
    },
    {
      head: '보유 및 이용 기간',
      rows: [
        {
          children:
            '서비스 제공 기간(관계법령의 규정에 의하여 보존할 필요가 있는 경우 사전 동의를 취득한 경우 해당 보유 기간)',
        },
      ],
    },
  ],
